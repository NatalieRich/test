...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"template/cards.hbs":[function(require,module,exports) {
module.exports = "/cards.e3094a3b.hbs";
...
var _cards = _interopRequireDefault(require("./template/cards.hbs"));

var _menu = _interopRequireDefault(require("./menu.json"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log(_cards.default);
var list = (0, _cards.default)(_menu.default);
var menuList = document.querySelector('.js-menu');
console.log(menuList);
menuList.innerHTML = list;
var switchControl = document.querySelector('#theme-switch-toggle');
...
},{"./template/cards.hbs":"template/cards.hbs","./menu.json":"menu.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
